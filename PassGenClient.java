...
public class PassGenClient extends JFrame implements ActionListener {
	...
	public PassGenClient() {
		...
		super.setDefaultCloseOperation( JFrame.DO_NOTHING_ON_CLOSE);   // in the original programme :JFrame.EXIT_ON_CLOSE  //disables the x button on the top right of the window
	...
	public void actionPerformed( ActionEvent ae ) {
		...
		//I added the message here to reminder user to take note of his seed before closing your program, if the user press yes, it will exit the program
		else if( ae.getSource() == exit ) {                           
			int confirmed = JOptionPane.showConfirmDialog(null, 
			        "Have you taken note of your seed?", "Exit Program Message Box",
	...
	public static void main( String[] args )  {
		...
		//I used look and feel here so that the program looks a bit better
		try {
            // Set System L&F
